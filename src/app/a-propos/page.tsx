    ...
    <div style={{ background: "var(--bg)", minHeight: "100vh" }}>
      ...
      <main style={{ maxWidth: 860, margin: "0 auto", padding: "4rem 1.5rem" }}>
        ...
        <section style={{ textAlign: "center", padding: "2rem 0" }}>
          ...
          <Link href="/contact" style={{ background: "var(--grad)", color: "white", padding: "0.9rem 2.5rem", borderRadius: 50, fontWeight: 700, textDecoration: "none", fontSize: "1rem", display: "inline-block" }}>
            Nous contacter
          </Link>
        </section>
      </main>
